...
class KeypointsProcessor(DataProcessor):
    ...
    def convert_from_albumentations(self, data: Sequence[Sequence], rows: int, cols: int, slices: int) -> List[Tuple]:
        params = self.params
    ...
    def convert_to_albumentations(self, data: Sequence[Sequence], rows: int, cols: int, slices:int) -> List[Tuple]:
        params = self.params
...
def convert_keypoints_to_albumentations(
    ...
    return [
        convert_keypoint_to_albumentations(kp, source_format, rows, cols, slices, check_validity, angle_in_degrees)
        for kp in keypoints
    ]
...
def convert_keypoints_from_albumentations(
    ...
    return [
        convert_keypoint_from_albumentations(kp, target_format, rows, cols, slices, check_validity, angle_in_degrees)
        for kp in keypoints
    ]
