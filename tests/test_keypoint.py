...
@pytest.mark.parametrize(
    ...
    [
        ((20, 30, 40, math.pi / 2, 0), (20, 30, 40, math.pi / 2, 0), 0, "xy"),
        ((20, 30, 40, math.pi / 2, 0), (30, 79, 40, 0, 0), 90, "xy"),
        ((20, 30, 40, math.pi / 2, 0), (79, 69, 40, 3 * math.pi / 2, 0), 180, "xy"),
        ((20, 30, 40, math.pi / 2, 0), (69, 20, 40, math.pi, 0), 270, "xy"),
        #
        ((20, 30, 40, math.pi / 2, 0), (59, 30, 20, math.pi / 2, 0), 90, "xz"),
...
def test_keypoint_rotate(keypoint, expected, angle, axes):
    actual = FGeometric.keypoint_rotate(keypoint, angle, axes, rows=100, cols=100, slices=100)
...
@pytest.mark.parametrize(
    ...
    [[[50, 50, 50, 0, 5], [120, 158, 100, math.pi / 2, 10], 90, 2, 0.1, 0.1]],
)
